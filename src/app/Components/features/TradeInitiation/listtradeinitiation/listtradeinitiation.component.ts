...
import { ListTradeInitiationButtonRenderComponent } from '../ListTradeInitiationButtonRender/list-trade-initiation-button-render/list-trade-initiation-button-render.component';
@Component({
...
export class ListtradeinitiationComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.gridOptions = {
      components: {
        ...
        buttonRenderer: ListTradeInitiationButtonRenderComponent,
           },
      // Other grid options
    };
  ...
  setColumnDefs(): void {
    this.columnDefs = [
      ...
      { headerName: 'Approved/Rejected', field: 'approvedrejected' },

      {headerName:'Status', field:'tiStatusName'},
{
