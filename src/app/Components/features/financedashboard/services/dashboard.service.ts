...
getTradeInitiationcount():Observable<string>
{
return this.http.get('https://localhost:7124/api/TransactionInitiation/GetTradeInitiationCount', {responseType:'text'}).pipe(
